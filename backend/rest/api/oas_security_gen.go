...
type SecurityHandler interface {
	...
	// Session token obtained via /auth/login Discord OAuth2 flow.
...
var operationRolesBearerAuth = map[string][]string{
	AddWishlistCharactersOperation:    []string{},
	ClearWishlistOperation:            []string{},
	RemoveWishlistCharactersOperation: []string{},
