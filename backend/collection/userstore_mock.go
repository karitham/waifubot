...
// Source: ../storage/userstore/querier.go
//
// Generated by this command:
//
//	mockgen -source=../storage/userstore/querier.go -destination=userstore_mock.go -package=collection -mock_names=Querier=MockUserQuerier
//
