...
type Querier interface {
	...
	GetStaleCharacters(ctx context.Context, arg GetStaleCharactersParams) ([]Character, error)
	...
	UpdateCharacterSync(ctx context.Context, arg UpdateCharacterSyncParams) (Character, error)
