...
type Querier interface {
	...
	GetByID(ctx context.Context, id int64) (GetByIDRow, error)
	GetStaleCharacters(ctx context.Context, arg GetStaleCharactersParams) ([]GetStaleCharactersRow, error)
	...
	UpdateCharacterSync(ctx context.Context, arg UpdateCharacterSyncParams) (UpdateCharacterSyncRow, error)
